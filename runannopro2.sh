...
then
	...
	echo "Please check your GO、KEGG、KOG/COG、Swissprot and “差异蛋白筛选结果.xlsx”文件，the pfam and eggNOG data are ready, you needn't check them"
fi
